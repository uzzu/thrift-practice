...
interface CalculatorIf extends \shared\SharedServiceIf {
  ...
  public function calculate($logid, \Uzzu\Thrift\Tutorial\Work $w);
  public function zip();
}

class CalculatorClient extends \shared\SharedServiceClient implements \Uzzu\Thrift\Tutorial\CalculatorIf {
  ...
  {
    $args = new \Uzzu\Thrift\Tutorial\Calculator_ping_args();
  ...
  public function recv_ping()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Uzzu\Thrift\Tutorial\Calculator_ping_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Uzzu\Thrift\Tutorial\Calculator_ping_result();
  ...
  {
    $args = new \Uzzu\Thrift\Tutorial\Calculator_add_args();
    $args->num1 = $num1;
    $args->num2 = $num2;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Uzzu\Thrift\Tutorial\Calculator_add_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Uzzu\Thrift\Tutorial\Calculator_add_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
  ...
  public function send_calculate($logid, \Uzzu\Thrift\Tutorial\Work $w)
  {
    $args = new \Uzzu\Thrift\Tutorial\Calculator_calculate_args();
    $args->logid = $logid;
    $args->w = $w;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Uzzu\Thrift\Tutorial\Calculator_calculate_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Uzzu\Thrift\Tutorial\Calculator_calculate_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Uzzu\Thrift\Tutorial\Calculator_zip_args();
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          'var' => 'w',
          'type' => TType::STRUCT,
          'class' => '\Uzzu\Thrift\Tutorial\Work',
          ),
        );
    }
    if (is_array($vals)) {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->w = new \Uzzu\Thrift\Tutorial\Work();
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        1 => array(
          'var' => 'ouch',
          'type' => TType::STRUCT,
          'class' => '\Uzzu\Thrift\Tutorial\InvalidOperation',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->ouch = new \Uzzu\Thrift\Tutorial\InvalidOperation();

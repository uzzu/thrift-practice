    ...
    module Calculator
      ...
      class Processor < ::SharedService::Processor 
        ...
        def process_calculate(seqid, iprot, oprot)
          ...
          rescue ::Uzzu::Tutorial::InvalidOperation => ouch
            result.ouch = ouch
          end
      ...
      class Calculate_args
        ...
        FIELDS = {
          ...
          W => {:type => ::Thrift::Types::STRUCT, :name => 'w', :class => ::Uzzu::Tutorial::Work}
        }
      ...
      class Calculate_result
        ...
        FIELDS = {
          SUCCESS => {:type => ::Thrift::Types::I32, :name => 'success'},
          OUCH => {:type => ::Thrift::Types::STRUCT, :name => 'ouch', :class => ::Uzzu::Tutorial::InvalidOperation}
        }
